...
import ConditionalLoginButton from "./login";
...
const Header = ({}: HeaderProps) => {
    return (
        <div
            className="px-[50px] py-[25px] bg-white dark:bg-black border-b globals__border-color flex justify-between items-left gap-4 py-3">
